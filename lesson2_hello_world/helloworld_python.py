...
@kfp.dsl.pipeline(name="hello-pipeline", description="Hello World Pipeline!")
...
if __name__ == "__main__":
    ...
    # kfp.compiler.Compiler().compile(hello_world_pipeline, "hello-world-pipeline.yml")
    compiler.Compiler().compile(hello_world_pipeline,
                                'hello-world-pipeline.json')
